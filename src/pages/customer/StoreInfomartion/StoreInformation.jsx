...
const StoreInformation = () => {
  ...
  return (
    <>
      ...
      <RentBoxModal isOpen={rentBoxModalOpen} setIsOpen={setRentBoxModalOpen} boxInfo={orderBoxInfo} storeInfo={location.state?.storeInfo} serviceTypeId={location.state.storeInfo.serviceTypeId} setLoadFinish={setLoadFinish} />
      <div role="status" className={`bg-black/50 w-full flex justify-center items-center fixed z-10 inset-0 md:hidden ${loadFinish == false && "hidden"}`}>
