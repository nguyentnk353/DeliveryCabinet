                                ...
                                <ul>
                                    ...
                                    <li className="flex items-center justify-between py-3 border-b border-slate-200">
                                        ...
                                        <div className="flex items-center whitespace-nowrap">
                                            ...
                                            <div className="text-sm font-medium text-slate-800">{wallet?.balance ? (<span>{new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(wallet?.balance)}</span>) : (<span>0 đ</span>)} </div>
                                        </div>
                                    </li>
                                </ul>
                            </div>
